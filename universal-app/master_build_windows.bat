...
:: Added Flask (Server), QRCode (Mobile), and Waitress (Production WSGI)
...
:: Build Desktop Client (GUI)
echo    - Compiling Client (%MAIN_SCRIPT%)...
...
:: Build Background Server (Service)
echo    - Compiling Server (%SERVICE_SCRIPT%)...
pyinstaller --noconfirm --noconsole --onefile ^
...
echo OutputDir=dist
echo OutputBaseFilename=WemoOps_Setup_v5.0.3
...
echo ========================================================
echo    BUILD COMPLETE!
echo    Installer: dist\WemoOps_Setup_v5.0.0.exe
echo ========================================================
pause